...
def parse_args():
    ...
    parser.add_argument('--train_mode', type=str, default='single_source', #시뮬 때릴거면 Multi source로 하는게 성능 더 올라갈 것 같은데
    ...
    parser.add_argument('--batch_size', type=int, default=16, # CWRU Batch size 4
                        help='Batch size')
